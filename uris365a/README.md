We have a "shared resource calendar" to help coordinate Uris 365a usage. The calendar is available to anyone on the Cornell Cmail network and is set to auto-accept all non-conflicting invitations. 
